...
public class Base62Encoder {
    ...
    private Base62Encoder(final byte[] alphabet) {
     ...
     */
    public static Base62Encoder createInstance() {
     ...
     * @return a {@link Base62} instance.
     */
    public static Base62Encoder createInstanceWithGmpCharacterSet() {
        return new Base62Encoder(CharacterSets.GMP);
    }
     ...
     * @return a {@link Base62} instance.
     */
    public static Base62Encoder createInstanceWithInvertedCharacterSet() {
        return new Base62Encoder(CharacterSets.INVERTED);
    }
